                ...
                return orderedWeeks.map((week, weekIndex) => {
                  ...
                  return (
                    <BuilderWeekCard
                      ...
                      showViewedIndicator={showViewedIndicator}
                      weekSettings={weekSettings}
                      selectedPeriod={selectedPeriod}
                      workouts={workouts}
                      editingWorkouts={editingWorkouts}
                      creatingWorkouts={creatingWorkouts}
                      openDates={openDates}
                      selectedCategories={selectedCategories}
                      workoutCategories={workoutCategories}
                      ...
                      savingEditors={savingEditors}
                      clientId={clientId}
                      eventId={eventId}
                      getDateKey={getDateKey}
                      getWorkoutForDate={getWorkoutForDate}
                      isDateInPeriod={isDateInPeriod}
                      getCategoryForDate={getCategoryForDate}
                      getEventIdForWorkout={getEventIdForWorkout}
                      generateInitialRounds={generateInitialRounds}
                      onEditWorkout={handleEditWorkout}
                      onCreateWorkout={handleCreateWorkout}
                      onCloseEditor={handleCloseEditor}
                      onSaveWorkout={handleSaveWorkout}
                      onSaveButtonClick={async (dateKey: string) => {
