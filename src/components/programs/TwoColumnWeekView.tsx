                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  onScheduleCellClick?.(normalizedDate, timeSlot, period || undefined);
                                }}
                              >
                                  ...
                                  <div className="space-y-0.5 relative">
                                    {sortEventsByTime(calendarEventsForSlot).map((event) => {
                                      ...
                                      return (
                                        <div
                                          key={event.id}
                                          className={`text-[10px] px-1 py-0.5 rounded text-white font-medium cursor-pointer hover:opacity-80 transition-opacity leading-tight ${shouldSpan ? 'hover:!z-[20]' : ''}`}
                                          style={{
                              ...
                              <div
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  onWorkoutCellClick?.(normalizedDate, timeSlot, period || undefined);
                                }}
                              >
